...
CONNECTIVITY_DIR="${PROJECT_OUTPUT_ROOT}/10_connectivity_analysis"
...
# Set to "yes" and provide projected x/y coordinates in metres to run Step 08.
RUN_CONNECTIVITY_ANALYSIS="no"
COORDINATES_FILE="${PROJECT_OUTPUT_ROOT}/plot_coordinates.csv"
