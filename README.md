...
Then create a project-specific override, update its input/output paths, filenames, thresholds, and resources, and run PoLoCo with `POLOCO_OVERRIDE_CONFIG`. This keeps the supplied case-study configuration unchanged.
